...
GEO= ['NAME','ITYPE','GEO_TYPE','AOI','FILTER_TYPE','RESULT_NAME', 'FIELDS']
ALPHA = ['NAME','ITYPE','PATH','JOIN_FIELD','FIELDS', 'RESULT_NAME']
FUNC = ['NAME','ITYPE','RESULT_NAME']
TABLES = ['NAME','ITYPE','TABLES']
DB = ['NAME','ITYPE','RESULT_NAME', 'INSTANCE', 'BEFORE','MAIN','AFTER', 'TABLE']
